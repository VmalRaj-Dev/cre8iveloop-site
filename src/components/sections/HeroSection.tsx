  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-3/4 right-1/4 w-24 h-24 bg-primary/5 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-1/4 left-1/3 w-16 h-16 bg-primary/15 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      </div>

      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-6xl md:text-8xl font-bold mb-6 animate-fade-in">
            <span className="text-foreground">Creativity That </span>
            <span className="bg-gradient-primary bg-clip-text text-transparent">Connects.</span>
            <br />
            <span className="text-foreground">Design That </span>
            <span className="bg-gradient-primary bg-clip-text text-transparent">Delivers.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
            ...
            <Button 
              ...
              className="border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-500 text-lg px-8 py-6 group"
            >
